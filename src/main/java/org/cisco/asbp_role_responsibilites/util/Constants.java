...
//Redis Keys
	...
	public static final String MEETING_EXTENSION = "meeting_extension";
	...
	public static final String SIGNUP_API = "/ems/user/register/tenant";
	...
	public static final String TENANT_REGISTER_MODULE = "TENANT_REGISTRATION";
	
	public static final String FORGOT_PWD_MODULE = "FORGOT_PASSWORD";
	
	public static final Long SUPER_ADMIN_ID = 1L;

	public static final String VMS_MODULE_KEY = "PRE_INVITE";
...
//	public static final String BULK_USERS_HEADERS = "Sr.No,Employee Code,Email Id,Employee Name,Mobile,Department,Vehicle No.,Car /Bike";
